...
const MENACARE_THUMB = "/manus-storage/MenaCare_df3d7218.webp";
const CIVICTECH_THUMB = "/manus-storage/WesternCape_PublicHospital_6e786dec.webp";
const COMMUNITY_THUMB = "https://images.unsplash.com/photo-1559027615-cd4628902d4a?auto=format&fit=crop&w=1200&q=88";
const FITNESS_THUMB = "/manus-storage/EliteGym_7b8094f3.webp";
const BEAUTY_THUMB = "/manus-storage/Blossom_nails_4e1038ef.webp";
const CINEMA_THUMB = "/manus-storage/Vixen_Cinema_49f1c55b.webp";
const MARKETING_THUMB = "/manus-storage/AdLuxe_Studio_f0549685.webp";
const PRODUCTIVITY_THUMB = "/manus-storage/AiProductivityDashboard_a649a44a.webp";
const CODE_THUMB = "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=1200&q=88";
const CALCULATOR_THUMB = "/manus-storage/SmartCalculator_09c44906.webp";
const TASK_THUMB = "/manus-storage/Laravel_Task_Management_1c916b79.webp";
const HOTEL_THUMB = "/manus-storage/StayHub_781ae28a.webp";
const BRAND_STRATEGY_THUMB = "/manus-storage/BrandStrategy_886e13a0.webp";
const ZEROWASTE_THUMB = "/manus-storage/ZeroConnect_cf091e9c.webp";
const BRAND_GUIDE_THUMB = "https://images.unsplash.com/photo-1558655146-9f40138edfeb?auto=format&fit=crop&w=1200&q=88";
const BUDGET_PLANNER_THUMB = "/manus-storage/BudgetPlanner_c0291530.webp";
const CAREERBUDDY_THUMB = "/manus-storage/CareerBuddy_a33295c9.webp";
        ...
        <section className="hero" id="home" style={{ backgroundImage: `url(${HERO_TEXTURE})` }}>
          ...
          <div className="hero-inner">
            <div className="hero-copy reveal">
              ...
              <p className="hero-pretitle">Software engineer &amp; creative technologist</p>
              <h1>Regaugetswe <em>Mphahlele</em></h1>
              <p className="hero-lede">I am a Software Engineer and Creative Technologist with an ICT qualification in Multimedia Applications. I build responsive web applications, create digital brand identities, and design user focused experiences that make practical ideas easier to use. I bring development and design together, collaborate thoughtfully, and turn clear briefs into useful digital solutions.</p>
